...
<template>
    <span class="btn" :class="{'btn-small':size =='small'}" :style="{'width':width}" @click="handleClick">
        <slot></slot>
        <span v-if="type == 'get'"><Icon type="edit" v-if="size!='small'" class="m-r-5"></Icon><span >签收</span></span>
